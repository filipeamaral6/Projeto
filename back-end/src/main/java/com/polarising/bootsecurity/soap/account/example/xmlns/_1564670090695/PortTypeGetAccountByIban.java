 ...
 * 
 */
@WebService(name = "PortType_GetAccountByIban", targetNamespace = "http://xmlns.example.com/1564670090695")
...
public interface PortTypeGetAccountByIban {
     ...
     */
    @WebMethod(operationName = "Operation", action = "/Account/Service.serviceagent/PortType_GetAccountByIbanEndpoint1/Operation")
